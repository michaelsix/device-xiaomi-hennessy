...
TARGET_KERNEL_SOURCE := kernel/xiaomi/hennessy
TARGET_KERNEL_CONFIG := hennessy_defconfig
...
#BOARD_EGL_CFG := vendor/xiaomi/hennessy/proprietary/vendor/lib/egl/egl.cfg
...
# Recovery
TARGET_RECOVERY_FSTAB := vendor/xiaomi/hennessy/proprietary/vendor/etc/fstab.$(TARGET_BOARD_PLATFORM)

# Sepolicy
#BOARD_SEPOLICY_DIRS += $(DEVICE_PATH)/device/mediatek/sepolicy
